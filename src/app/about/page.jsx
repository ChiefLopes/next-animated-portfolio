  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll">
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-14 lg:p-20 xl:p-28 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64">
          {/* BIOGRAPHY CONTAINER */}
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="max-w-[500px] text-lg">
              ...
              suscipit nostrum nisi fugit provident molestiae eligendi natus
              nulla explicabo! Maiores exercitationem pariatur deserunt vitae
              veniam? Culpa tempora cum laudantium consequuntur.
            </p>
